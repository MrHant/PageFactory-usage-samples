...
namespace GetPageObject_method
{
    ...
    public class GoogleResultsPage : BasePage<GoogleResultsPage> {
    ...
    public class Tests
    {
        ...
        public void EnterTextInGoogleSearchInput()
        {
            ...
            searchPage.GetPageObject().SearchFor("Cheese");
            
            // list found results
            var resultsPage = new GoogleResultsPage(driver);
            var results = resultsPage.GetPageObject().SearchResultsTitles();
